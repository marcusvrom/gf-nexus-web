...
(function () {
  ...
  var en = {
    ...
    'idx.hero.meta2':      'At the heart of it',
    'idx.hero.meta3':      'As you remember it',

    'idx.pillars.kicker':  'What is GF Nexus',
    'idx.pillars.h2':      'A renaissance, not a copy.',
    'idx.pillars.desc':    'We rebuilt the Grand Fantasia experience with respect for what made it special — but with the stability, community, and care that a server made by people who love the game can offer.',
    'idx.pillars.p1.title':'Progression with value',
    ...
    'idx.pillars.p2.text': 'The premium currency inspired by the old APs, integrated into the shop and marketplace — focused on convenience and cosmetics.',
    ...
    'idx.explore.c1.text':      'Understand our vision, our commitment to the community, the planned progress, and the server\'s proposal.',
    ...
    'idx.faq.a1':     'No. Playing is completely free. We will have a shop with Nexus Points (NP) focused on cosmetics and convenience.',
    'idx.faq.q2':     'What are the EXP and drop rates?',
    'idx.faq.a2':     'Balanced rates, shaped together with the community: progression has value and the economy makes sense long-term, without losing the fun of the journey.',
    ...
    /* ── sobre.html ───────────────────────────────────────────────────── */
    'sobre.eyebrow':  'About the project · Built by the community · Living community',
    'sobre.h1':       'A new gathering place for those who still carry <em>Saphael</em> in their memory.',
    'sobre.lead':     'GF Nexus was born to bring together old and new players in an experience true to the essence of Grand Fantasia, with valued progression, an active community, and transparent development.',
    'sobre.cta1':     'Join Discord',
    'sobre.cta2':     'Help the project',

    'sobre.vision.kicker': 'Our vision',
    'sobre.vision.h2':     'Revitalizing the community with respect for the essence of the game.',
    ...
    'sobre.vision.p2':     'We are building a solid, community-focused foundation with improvements in organization, communication, support, documentation, and long-term planning. The goal is for each stage of the server to be accompanied by the community, with space for suggestions, testing, and feedback.',

    'sobre.feat.p1.title': 'Progression with value',
    'sobre.feat.p1.text':  'Balanced rates, relevant achievements, and an evolution curve that rewards dedication.',
    ...
    'sobre.id.text':  'Community-focused Grand Fantasia private server preparing for beta.',
    'sobre.id.li1':   '<strong>Focus:</strong> Brazilian community',
    'sobre.id.li2':   '<strong>Progression:</strong> balanced',
    ...
    'sobre.pillars.p2.title': 'Fair economy',
    'sobre.pillars.p2.text':  'Nexus Points for convenience and cosmetics, preserving the game\'s balance and economy.',
    'sobre.pillars.p3.title': 'Nostalgic spirit',
    'sobre.pillars.p3.text':  'Respect for the game\'s vibe, sprites, parties, trading, and group adventure.',
    ...
    'news.sec.desc':   'The main news and improvements applied to the server.',

    'news.u1.tag':   'Content',
    'news.u1.title': 'Major content expansion',
    'news.u1.text':  'We adopted a new content base with hundreds of new enchantments and abilities, plus collections and monsters — much more to explore in Saphael.',
    'news.u1.meta':  'Update · 2026-06-04',
    'news.u2.tag':   'Launcher',
    'news.u2.title': 'The launcher is now multilingual',
    'news.u2.text':  'The launcher now lets you choose the game language between Portuguese, English, Spanish, and French — to welcome players from every region.',
    'news.u2.meta':  'Update · 2026-06-03',
    'news.u3.tag':   'Stability',
    'news.u3.title': 'More stability and fixes',
    'news.u3.text':  'We applied stability fixes, client version adjustments, and game shutdown improvements for a smoother experience from start to finish.',
    'news.u3.meta':  'Update · 2026-06-04',
    'news.u4.tag':   'Event',
    'news.u4.title': 'Weekend EXP boost',
    'news.u4.text':  'On weekends, experience gain gets a special boost for those playing with the community. Take the chance to level up faster with friends.',
    'news.u4.meta':  'Recurring event · Weekends',
    ...
    'guia.whatIs.p1.title': 'Cooperative adventure',
    ...
    'guia.step5.text':  'Complete quests and defeat same-level monsters to gain EXP. At each class evolution (levels 16, 31, and beyond), you unlock new abilities and look visually more imposing. Progression is <strong>balanced</strong> — worth it.',
    ...
    'guia.tip5.text':   'Here gold has real value — spend wisely and be suspicious of trades that seem "too good."',
    ...
    'guia.gloss.t5.q':   'Rates',
    'guia.gloss.t5.a':   'The server\'s EXP and drop rates. At the Nexus they are balanced, designed so that progression has value and the economy makes sense long-term.',
    'guia.gloss.t6.q':   'NP (Nexus Points)',
    'guia.gloss.t6.a':   'The server\'s premium currency, focused on convenience and cosmetics.',
    ...
    'guia.footer.legal': 'GF Nexus · non-profit private server · 2026<br>Grand Fantasia &copy; X-Legend Entertainment. Fan project, no official affiliation.<br>Guide based on the game\'s mechanics and client data from this version.',
  };
